...
public class DifficultyScreen extends InputAdapter implements Screen {
    ...
    public DifficultyScreen(DarknessGame game) {
    ...
    public void show() {
        ...
        viewport = new FitViewport(Constants.DIFFICULTY_SCREEN_WORLD_SIZE, Constants.DIFFICULTY_SCREEN_WORLD_SIZE);
    ...
    public void render(float delta) {
        ...
        renderer.circle(Constants.EASY_CENTER.x, Constants.EASY_CENTER.y, Constants.DIFFICULTY_BUBBLE_RADIUS, Constants.DIFFICULT_LABEL_CIRCLE_SEGMENTS);
        renderer.setColor(Constants.MEDIUM_COLOR);
        renderer.circle(Constants.MEDIUM_CENTER.x, Constants.MEDIUM_CENTER.y, Constants.DIFFICULTY_BUBBLE_RADIUS, Constants.DIFFICULT_LABEL_CIRCLE_SEGMENTS);
        renderer.setColor(Constants.HARD_COLOR);
        renderer.circle(Constants.HARD_CENTER.x, Constants.HARD_CENTER.y, Constants.DIFFICULTY_BUBBLE_RADIUS, Constants.DIFFICULT_LABEL_CIRCLE_SEGMENTS);
        renderer.end();
